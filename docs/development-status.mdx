...
description: "Oite's core language is complete. Library functionality (HTTP, TLS, fs, etc.) will be developed in the  ecosystem."
---
...
## Core Language: Complete[​](#core-language-complete "Direct link to Core Language: Complete")
...
```
./target/release/oite compiler/main.ot llvm input.ot  # → input.ot.llclang input.ot.ll -c -o input.o                          # → input.oclang input.o -o output                                     # → native binary
```
...
## What's Intentionally Minimal[​](#whats-intentionally-minimal "Direct link to What's Intentionally Minimal")
...
[Edit this page](https://github.com/warpy-ai/script/tree/main/docs/docs/development-status.md)
